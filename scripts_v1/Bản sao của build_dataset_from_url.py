...
if __name__=='__main__':
    ...
    parser.add_argument('--image_processing_script', type=str, default='dataset/image_processing_instructions_sample.txt',
    ...
    train = load_json('dataset/train_sample.json')
    val = load_json('dataset/val_sample.json')
    test = load_json('dataset/test_sample.json')
    ...
    process_images_from_instructions(args.image_processing_script, 'dataset/img_sample/', 'dataset/processed_img/')
