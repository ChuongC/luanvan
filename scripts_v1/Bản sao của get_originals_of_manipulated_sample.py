...
if __name__=='__main__':
    ...
    evidence = load_json('dataset/retrieval_results/evidence_sample.json')
    ...
    for img_path in manipulation_detection_test_image_paths:
        ...
        if len(subset) > 0:
            sorted_evidence_by_date_index = pd.DataFrame(subset).sort_values(by='evidence_date').index.to_list()
